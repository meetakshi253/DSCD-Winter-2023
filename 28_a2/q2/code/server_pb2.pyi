...
class PrimaryDeleteRequest(_message.Message):
...
class PrimaryWriteRequest(_message.Message):
    ...
    uuid: str
    version: str
    def __init__(self, uuid: _Optional[str] = ..., name: _Optional[str] = ..., content: _Optional[str] = ..., version: _Optional[str] = ...) -> None: ...
